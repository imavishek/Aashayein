            ...
            if (!this.grid) {
                ...
                if (ee.recordpos = ee.recordpos || ("rtl" === ee.direction ? "left" : "right"), ee.autoResizing.widthOfVisiblePartOfSortIcon = void 0 !== ee.autoResizing.widthOfVisiblePartOfSortIcon ? ee.autoResizing.widthOfVisiblePartOfSortIcon : "fontAwesome" === ee.iconSet ? 13 : 12, ee.datatype = void 0 !== ee.datatype ? ee.datatype : void 0 !== e || null == ee.url ? "local" : null != ee.jsonReader && "object" == typeof ee.jsonReader ? "json" : "xml", ee.jsonReader = ee.jsonReader || {}, ee.url = ee.url || "", ee.cellsubmit = void 0 !== ee.cellsubmit ? ee.cellsubmit : void 0 === ee.cellurl ? "clientArray" : "remote", ee.gridview = void 0 !== ee.gridview ? ee.gridview : null == ee.afterInsertRow, void 0 !== e && (ee.data = e, Xe.data = e), void 0 !== t && (ee.datastr = t, Xe.datastr = t), "TABLE" === D.tagName.toUpperCase())
                    if ("" === D.id && h.attr("id", randId()), void 0 !== document.documentMode && document.documentMode <= 5) F("Grid can not be used in this ('quirks') mode!");
                        ...
                        var k, p = $("<div class='" + _("gView", "ui-jqgrid-view") + "' role='grid' aria-multiselectable='" + !!ee.multiselect + "'></div>"),
                            f = jgrid.msie;
                        ...
                        var v, w = function(e, t, r, i, a, o) {
                            ...
                            M = function(i) {
                                ...
                                if (!r.hDiv.loading) {
                                    ...
                                    var b = ee.scroll ? a.rows.length - 1 : 1,
                                        ...
                                        y = function() {
                                            var e;
                                            if (ee.autoresizeOnLoad) Qe.autoResizeAllColumns.call(t), clearArray(ee.columnsToReResizing), ee.autowidth && Qe.setGridWidth.call(t, t.closest(".ui-jqgrid").parent().width(), !0);
                                            else {
                            ...
                            C = function(e, d) {
                                var t, r, i, a, o, l, n, s, c, u = _("states.hover"),
                                    p = _("states.disabled"),
                                    f = "<td class='ui-pg-button " + p + "'><span class='ui-separator'></span></td>",
                                    h = "",
                        ...
                        if (ee.colNames.length === ee.colModel.length) {
                            ...
                            var X, Q, J, ne, se, de, ce, ue, pe, fe = [],
                                ...
                                ve = "<tbody><tr style='display:none;'>",
                                be = _("states.hover"),
                            ...
                            var ye, xe, je, Ce, De, Se, qe, Fe, Re, _e, Ie, Ge = $("<table class='" + _("hTable", "ui-jqgrid-htable") + "' style='width:1px' role='presentation' aria-labelledby='gbox_" + ee.id + "'>" + me + ve + "</table>");
                            ...
                            if (ee.disableClick = !1, $("th", Ge[0].tHead.rows[0]).each(function(e) {
                                    ...
                                    if (!(J = null) === t.hidden && (i.css("display", "none"), n = "display:none;"), Ne += "<td role='gridcell' " + (t.classes ? "class='" + t.classes + "' " : "") + "style='height:0;width:" + Q + "px;" + n + "'></td>", ie.headers[e] = {
                                            width: Q,
                                            el: this
                                        }, "boolean" != typeof(ne = t.sortable) && (t.sortable = !0, ne = !0), "cb" !== r && "subgrid" !== r && "rn" !== r && ne && ee.viewsortcols[2] && a.addClass("ui-jqgrid-sortable"), ne)
                                        if (ee.multiSort) {
                                    ...
                                    var t, r, i = $(this),
                                        a = i.closest(".ui-jqgrid-hdiv").hasClass("frozen-div");
                            ...
                            if (ie.hDiv = document.createElement("div"), $(ie.hDiv).css({
                                    width: ie.width + "px"
                                }).addClass(_("hDiv", "ui-jqgrid-hdiv")).append(Me).scroll(function() {
                                    var e = $(this).next(".ui-jqgrid-bdiv")[0];
                                    return e && (e.scrollLeft = this.scrollLeft), !1
                                }), $(Me).append(Ge), Ge = null, Te && $(ie.hDiv).hide(), ee.rowNum = parseInt(ee.rowNum, 10), (isNaN(ee.rowNum) || ee.rowNum <= 0) && (ee.rowNum = ee.maxRowNum), ee.pager) "string" == typeof ee.pager && "#" !== ee.pager.substr(0, 1) ? (Ae = ee.pager, Ee = $("#" + jqID(ee.pager))) : !0 === ee.pager ? (Ae = randId(), (Ee = $("<div id='" + Ae + "'></div>")).appendTo("body"), ee.pager = "#" + jqID(Ae)) : Ae = (Ee = $(ee.pager)).attr("id"), 0 < Ee.length ? (Ee.css({
                                width: ie.width + "px"
                            }).addClass(_("pager.pager", "ui-jqgrid-pager " + Pe)).appendTo(m), Te && Ee.hide(), C.call(D, Ae, ""), ee.pager = "#" + jqID(Ae)) : ee.pager = "";
                            ...
                            if ("string" == typeof ee.datatype && (ee.datatype = ee.datatype.toLowerCase()), ee.toppager ? (ee.toppager = ee.id + "_toppager", ie.topDiv = $("<div id='" + ee.toppager + "'></div>")[0], $(ie.topDiv).addClass(_("pager.pager", "ui-jqgrid-toppager" + (ee.caption ? "" : " " + Be))).css({
                                    width: ie.width + "px"
                                }).insertBefore(ie.hDiv), C.call(D, ee.toppager, "_t"), ee.toppager = "#" + jqID(ee.toppager)) : "" !== ee.pager || ee.scroll || (ee.rowNum = ee.maxRowNum), ee.footerrow && (ie.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Me = $("<div class='ui-jqgrid-hbox" + ("rtl" === k ? "-rtl" : "") + "'></div>"), $(ie.sDiv).append(Me).width(ie.width).insertAfter(ie.hDiv), $(Me).append(ke), ie.footers = $(".ui-jqgrid-ftable", ie.sDiv)[0].rows[0].cells, ee.rownumbers && (ie.footers[0].className = _("rowNum", "jqgrid-rownum")), Te && $(ie.sDiv).hide()), Me = null, ee.caption) {
                                var Ye = ee.datatype;
                                !0 === ee.hidegrid && ($(".ui-jqgrid-titlebar-close", ie.cDiv).click(function(e) {
                                    var t = ".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",
                                        r = this;
    ...
    jgrid.extend({
        ...
        rotateColumnHeaders: function(w, y) {
            return this.each(function() {
                ...
                for ($.isArray(w) || (w = [w]), e = 0; e < w.length; e++) o = w[e], 0 <= (t = isNaN(o) ? v.iColByName[o] : parseInt(o, 10)) && (r = this.grid.headers[t].el, i = t < b ? $(r).add($(this.grid.fhDiv.find("#" + jqID(r.id)))) : $(r), l = i.children("div"), n = l.children("span.s-ico"), d = l.children("span.ui-jqgrid-sort-order"), (s = l.children("span." + v.autoResizing.wrapperClassName)).length < 1 && (n.detach(), d.detach(), l.wrapInner("<span class='" + v.autoResizing.wrapperClassName + "'></span>"), s = l.children("span." + v.autoResizing.wrapperClassName), l.each(function(e) {
                    ...
                    paddingLeft: h + "px",
                    paddingRight: g + "px"
                }), l.css("min-width", a - p - f + "px").addClass("ui-jqgrid-rotate").css({
                    bottom: 0
            ...
            return this.each(function() {
                ...
                if (l && null != o) {
                    ...
                    var f, h, g, m, v = o.colModel,
                        ...
                        D = l.sDiv,
                        S = l.cols,
                        q = $(C).find(">div>.ui-jqgrid-htable>thead>tr").first()[0].cells,
                        F = function(e) {
            ...
            return this.each(function() {
                ...
                if (this.grid) {
                    ...
                    0 <= e && (t = $(this.grid.headers[e].el), i.frozenColumns && (t = t.add(this.grid.fhDiv.find("#" + jqID(t)))), a && (t.each(function() {
                        var e = $("[id^=jqgh_]", this),
                            t = e.children("span.ui-jqgrid-cell-wrapper");
        ...
        getAutoResizableWidth: function(e) {
            ...
            var r, i, a, o, l, n = (t = t[0]).rows,
                ...
                g = u.children(".ui-jqgrid-sort-order"),
    ...
    jgrid.jqModal = jgrid.jqModal || {}, $.extend(!0, jgrid.jqModal, {
        ...
        createModal: function(e, t, r, i, a, o, l) {
            ...
            if (w.left && (w.left += "px"), $(d).css($.extend({
                ...
                if (r.resize)
                    if ($.fn.jqResize) $(b).append("<div class='jqResize ui-resizable-handle ui-resizable-se " + r.resizingRightBottomIcon + "'></div>"), $(c).jqResize(".jqResize", p);
                    else try {
                        $(d).resizable({
                            handles: "se, sw",
                            alsoResize: p
        ...
        destroyGroupHeader: function(c) {
            return void 0 === c && (c = !0), this.each(function() {
                var e, t, r, i, a, o = this.grid,
                    l = this.p.colModel,
                    n = $("table.ui-jqgrid-htable thead", o.hDiv);
                if (o) {
                    ...
                    $(n).children("tr.ui-jqgrid-labels").remove(), $(n).prepend(s), !0 === c && $(this).jqGrid("setGridParam", {
                        groupHeader: null
                    })
                }
            })
        ...
        setGroupHeaders: function(F) {
            return F = $.extend({
                ...
                var e, t, r, i, a, o, l, n, s, d, c, u, p, f, h = this,
                    ...
                    b = v.length,
                    w = h.grid.headers,
                    y = $("table.ui-jqgrid-htable", h.grid.hDiv),
                ...
                for ($(h).prepend(D), r = $("<tr>", {
                        role: "row"
                    }).addClass("ui-jqgrid-labels jqg-third-row-header"), e = 0; e < b; e++)
                ...
                if (o && null != v && !0 !== v.frozenColumns) {
                    ...
                    if (!0 !== v.subGrid && !0 !== v.treeGrid && !v.scroll) {
                        ...
                        if (0 <= l && n) {
                            ...
                            var f = $(".ui-jqgrid-htable", v.gView).clone(!0),
                                h = f[0].tHead.rows;
                            if (v.groupHeader) {
                ...
                if (E.initFilter = $.extend(!0, {}, E.filter), r) {
                    ...
                    this.onchange = function() {
                        ...
                        if (E.groupButton && (h = $("<input type='button' value='+ {}' title='" + k("addGroupTitle") + "' class='" + O("searchDialog.addGroupButton", "add-group") + "'/>")).on("click", function() {
                            ...
                            var g, m = $("<input type='button' value='+' title='" + k("addRuleTitle") + "' class='" + O("searchDialog.addRuleButton", "add-rule ui-add") + "'/>");
                            m.on("click", function() {
                                var e, t, r;
                        ...
                        if (void 0 !== i.groups)
                            for (a = 0; a < i.groups.length; a++) u = $("<tr></tr>"), t.append(u), p = $("<td class='first'></td>"), u.append(p), (f = $("<td colspan='4'></td>")).append(this.createTableForGroup(i.groups[a], i)), u.append(f);
        ...
        json2xml: function(e, t) {
            var r, s = function(e, t, r) {
                    ...
                    if (e instanceof Array)
                        if (0 === e.length) n += r + "<" + t + ">__EMPTY_ARRAY_</" + t + ">\n";
                        else
                ...
                if (l.grid && null != n && !(l.nav && 0 < $(T).find(".navtable").length)) {
                    ...
                    if (l.grid) {
                        ...
                        var v, b, w, y, x, j, C, D = 1,
                            ...
                            A = function(e, t, r) {
                                var i = $("<div class='" + m + "' tabindex='0' role='button'></div>"),
                                    a = d[e + "icon"],
                                    o = $.trim(d[e + "text"]);
                ...
                var b, w, y, x, j, C, D, S, q = {},
                    ...
                    N = function(t, e) {
                        try {
                            ...
                            h.call(u, O, t, k, {
                                top: r.top,
                                left: r.left + $(u).closest(".ui-jqgrid").offset().left
                            })
                        } catch (e) {
                            m(t)
                        }
                    ...
                    if (D) p.jqGrid("progressBar", {
                        ...
                        error: function(e, t, r) {
                            if (p.triggerHandler("jqGridInlineErrorSaveRow", [o, e, t, r, c]), g(c.errorfunc)) c.errorfunc.call(u, o, e, t, r);
                                ...
                                try {
                                    h.call(u, O, '<div class="' + getGuiStateStyles.call(u, "error") + '">' + i + "</div>", k, {
                                        buttonalign: "right"
                                    })
                                } catch (e) {
                                    m(i)
        ...
        addSubGrid: function(y, l) {
            return this.each(function() {
                var e, t, r, s = this,
                    ...
                    m = function(e, t, r) {
                        var i = c.align[r],
                            a = $("<td" + (i ? " style='text-align:" + i + ";'" : "") + "></td>").html(t);
                        e.append(a)
                    },
                    v = function(e, i) {
                    ...
                    b = function(e, t) {
                        ...
                        if (null != s)
                            for (i = 0; i < s.length; i++) {
                                if (l = s[i], r = $("<tr class='" + f + "'></tr>"), !0 === n.repeatitems)
                    ...
                    w = function(e, t, r) {
                        var i, a, o = u("legacyTable", "ui-jqgrid-legacy-subgrid" + (!0 === d.altRows && $(s).jqGrid("isBootstrapGuiStyle") ? " table-striped" : "")),
                        ...
                        if ($.each(d.colModel, function() {
                            ...
                            if (!0 === d.subGridOptions.reloadOnExpand || !1 === d.subGridOptions.reloadOnExpand && !$(r).hasClass("ui-subgrid")) {
                                ...
                                $(t).after("<tr role='row' class='" + n + "'>" + e + "<td class='" + h + "'><span class='" + o("openicon") + "'></span></td><td colspan='" + parseInt(d.colNames.length - l, 10) + "' class='" + g + "'><div id='" + a + "' class='tablediv'></div></td></tr>"), $(s).triggerHandler("jqGridSubGridRowExpanded", [a, i]), $.isFunction(d.subGridRowExpanded) ? d.subGridRowExpanded.call(s, a, i) : function(e) {
                                    ...
                                    if (c.params)
                                        for (r = 0; r < c.params.length; r++) void 0 !== (t = d.iColByName[c.params[r]]) && (a[d.colModel[t].name] = $(e.cells[t]).text().replace(/\&#160\;/gi, ""));
