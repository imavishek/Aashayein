...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${contextRoot}/assets/css/setPassword.css">
	...
	<div class="container-login100">
		...
		<div class="innerContent">
			<div class="wrap-login100" style="background-color: #a7a4a4bf;">
				<springForm:form action="${contextRoot}/EmployeeRegistration/setPassword.abhi" cssClass="login100-form" id="passwordForm" method="POST" modelAttribute="password">
					...
					<tr>
						<td><springForm:password path="password" maxlength="25" cssClass="inputfieldPassword" placeholder="Password"/></td>
					...
					<tr>
						<td><springForm:password path="confirmPassword" maxlength="25" cssClass="inputfieldPassword" placeholder="Confirm Password"/></td>
					</tr>
					<tr>
